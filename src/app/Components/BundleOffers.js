...
import { Package, ChevronDown, Check, Percent } from 'lucide-react';

const BundleOffers = ({ formData, onOrderComplete, selectedBundle, setSelectedBundle, bundleSelections, setBundleSelections, showButtons = true }) => {
    const colors = [
